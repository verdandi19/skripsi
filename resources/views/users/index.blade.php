<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-10">
                <a href="{{ route('users.create') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                    + Create User
                </a>
            </div>
            <br>
            <div class="bg-white">
                <table class="table-auto w-full">
                    ...
                    <tr>
                        ...
                        <th class="border px-6  py-4">Jabatan</th>
                    ...
                    <tbody>
                        @forelse($user as $item)
                            <tr>
                                ...
                                <td class="border px-6 py-4">{{ $item->jabatan }}</td>
